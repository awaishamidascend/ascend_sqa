...
public class Dental_Equipment_Listing_Search {
	 public static void main(String[] args) throws InterruptedException {
		    ...
		    //Clicking on Dental equipment dropdown
		    System.out.println("Clicking on dropdown...");
		    driver.findElement(By.xpath("//*[@id=\"root\"]/div[1]/div[1]/div[4]/ul[1]/li[2]")).click();
		    Thread.sleep(5000);
		    
		    //Clicking on dental Equipment listing
		    System.out.println("Clicking on listing...");
		    driver.findElement(By.xpath("/html/body/div[1]/div[1]/div[1]/div[4]/ul[1]/li[2]/ul/div[2]/li[2]/a/span")).click();
		    Thread.sleep(5000);
