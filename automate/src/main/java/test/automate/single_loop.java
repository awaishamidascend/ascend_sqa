...
public class single_loop{
	public static void main(String[] args) throws InterruptedException {
		...
		for (int i = 0; i <= 1; i++) {
			...
			int dropdownId = available + 2 ; // Adjusting ID increment

			var available1 = dropdownId;

			// FOR Avaiable
			WebElement dropdownInput1 = wait.until(ExpectedConditions.presenceOfElementLocated(By.id("react-select-" + dropdownId + "-input")));
			dropdownInput1.sendKeys("Available");
