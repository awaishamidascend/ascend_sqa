    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        try {
            ...
            for (int i = 0; i <= 55; i++) {
                ...
                // Directly interact with "New Stock Received" field
                WebElement newStockReceivedField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='row-" + i + "']//div[@id='cell-6-undefined']//input[@name='amountLeft']")));
                ...
                // Directly interact with "Daily Consumption" field
                WebElement dailyConsumptionField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='row-" + i + "']//div[@id='cell-7-undefined']//input[@name='amountLeft']")));
                ...
                // Directly interact with "Stock on Hand" field
                WebElement stockonhandField = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='row-" + i + "']//div[@id='cell-8-undefined']//input[@name='amountLeft']")));
